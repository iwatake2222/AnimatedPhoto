...
/**
 * Created by takeshi on 17/06/16.
 */
public class Consts {
    public static final int SIZE_S = 640;
    public static final int SIZE_M = 1280;
    public static final int SIZE_L = 1920;
    public static final int DEFAULT_FILTER_NUM_H = 16;
